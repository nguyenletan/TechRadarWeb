        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                function renderChart() {
                    ...
                    var colorPattern = scope.colorPattern = [
                      [ "#7eb5d0", "#6B5189", "#8FB53D", "#C02134"],
                      ["#A1C7DB", "#8C7AA3", "#ABC473", "#DB6673"],
                      [ "#D4E3ED", "#C4BAD1", "#D6E0BA", "#EBA6B0"]
                  ]; //['#5bc0eb', '#fa7921', '#9bc53d', '#e55934', '#fde74c']
                    ...
                    var chartData = radarService.radar.getDataByLocationForOutter(scope.locationActive);
