      ...
      this.getTechList = function (location) {
        ...
        function countDevBySkillAndLocation(skillName, location) {
          ...
          return {
            ...
            PSE: [...filterByAvailablePSESeniority, ...filterByUnAvailablePSESeniority],
            SSE: [...filterByAvailableSSESeniority, ...filterByUnAvailableSSESeniority],
            SE: [...filterByAvailableSESeniority, ...filterByUnAvailableSESeniority]
